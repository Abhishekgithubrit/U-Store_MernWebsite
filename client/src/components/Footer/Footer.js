        ...
        <footer>
            <div className="footer__container">
                <div className="footer__items__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            ...
                            <li className="footer__contact">
                                <EmailIcon /> <span>shop@U-Store.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>U-Store Ghaziabad</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2023 U-Store Ltd. |</li>
                        <li className="footer__terms__condition"> | Terms & Condition |</li>
                        <li className="footer__privacy__policy">| Privacy Policy</li>
                        <li className="footer__privacy__policy">| @ Copyright Abhishek_Chatruvedi & teams</li>
                        <li className="footer__privacy__policy">| Teams-Aditya. Abhinav, Abhishek</li>
